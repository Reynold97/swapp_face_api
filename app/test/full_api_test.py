...
# python app/test/full_api_test.py --endpoint url --mode one_to_many --face_filename 1.jpg --model_filename pareja2.jpg
# python app/test/full_api_test.py --endpoint url --mode sorted --direction left_to_right --face_filename pareja1.jpg --model_filename pareja2.jpg
# python app/test/full_api_test.py --endpoint url --mode sorted --direction right_to_left --face_filename pareja1.jpg --model_filename pareja2.jpg
# python app/test/full_api_test.py --endpoint url --mode similarity --face_filename pareja1.jpg --model_filename pareja2.jpg
# python app/test/full_api_test.py --endpoint url --use_codeformer --codeformer_fidelity 0.7 --face_filename 1.jpg --model_filename 2.png
# python app/test/full_api_test.py --endpoint url --mode one_to_many --use_codeformer --codeformer_fidelity 0.5 --upscale 4 --face_filename 1.jpg --model_filename pareja2.jpg
